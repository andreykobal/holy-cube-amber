...
const unityContext = new UnityContext({
  ...
  loaderUrl: "unitybuild/5.loader.js",
  dataUrl: "unitybuild/5.data",
  frameworkUrl: "unitybuild/5.framework.js",
  codeUrl: "unitybuild/5.wasm",
...
export default function App() {
  function sendWalletIdToGame() {
    unityContext.send("WalletProvider", "SetWallet", 'infinitynft.near');
